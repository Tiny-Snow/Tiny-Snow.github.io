...
I have published multiple papers in top-tier machine learning conferences, such as NeurIPS, KDD, etc. I have also served as a reviewer for conferences including NeurIPS, ICLR, etc. I am currently focusing on research in **recommender systems (RS)**, particularly on **RS optimization** and **Generative RS**. My other research interests include **reinforcement learning** and **large language models**.
